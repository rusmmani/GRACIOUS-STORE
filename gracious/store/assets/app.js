...
async function supa(){if(!window.supabase||!window.GRACIOUS_CONFIG)return null;return window.supabase.createClient(window.GRACIOUS_CONFIG.supabaseUrl,window.GRACIOUS_CONFIG.supabaseAnonKey)}
